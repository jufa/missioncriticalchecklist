...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   rootNavigationController = (UINavigationController *)self.window.rootViewController;
    ...
    /*
    ChecklistTableViewController *cltvc = (ChecklistTableViewController *) [[nav viewControllers]  objectAtIndex:0];
    cltvc.managedObjectContext = self.managedObjectContext;
    */
    
    //TODO: Pass omly appropriate parts of fetchControllers to viewcontrollers
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MissionCriticalChecklist" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MissionCriticalChecklist.sqlite"];
...
#pragma mark - file attachment - handle "open with"
